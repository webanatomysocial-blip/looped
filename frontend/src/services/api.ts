...
export const seoApi = {
  ...
  saveReport: (clientId: number, data: { name: string; range: string; start_date?: string; end_date?: string; compare_start?: string; compare_end?: string; country?: string; manual_snapshot?: any; agency_name?: string }) => api.post(`/seo/saved-reports/${clientId}`, data),
