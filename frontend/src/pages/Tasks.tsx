...
export default function Tasks() {
  ...
  return (
          ...
          <table className="data-table">
            ...
            <tbody>
              {paginated.map((task) => (
                ...
                <tr>
                  <td>
                    <div className="task-cell-main" style={{ cursor: 'pointer' }} onClick={() => setViewTask(task.id)}>
    ...
    {previewUser && (
      <IdCardModal name={previewUser.name} role={previewUser.role} avatarUrl={previewUser.avatar_url} onClose={() => setPreviewUser(null)} />
    )}
    </>
  );
}
