      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ background: '#1d2033', borderRadius: 14, padding: '22px 26px', marginBottom: 24, color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <p style={{ fontSize: 12, color: '#94a3b8', margin: 0 }}>Powered by webanatomy</p>
          </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 11, color: '#94a3b8', marginTop: 32 }}>Generated by webanatomy · This is a read-only shared report</p>
      </div>
    </div>
  );
}
